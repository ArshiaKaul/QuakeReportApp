...
public class EarthquakeAdapter extends ArrayAdapter<Earthquake> {
    ...
    public View getView(int position, View convertView, ViewGroup parent){
        ...
        String place = new String(currentEarthquake.getLocation());

        if(place.toLowerCase().contains("of")){
            String placeParts[] = place.split("of ");
            String distancePart = placeParts[0];
            String locationPart = placeParts[1];

            TextView distanceView = (TextView) listItemView.findViewById(R.id.distance);
            distanceView.setText(distancePart + " of");

            TextView locationView = (TextView) listItemView.findViewById(R.id.location);
            locationView.setText(locationPart);
        }else{
            TextView distanceView = (TextView) listItemView.findViewById(R.id.distance);
